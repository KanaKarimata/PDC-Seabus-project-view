...
export default {
  ...
  methods: {
    ...
    getUrl() {
      ...
      this.url = process.env.VUE_APP_SIGNAGE_VIEW_URL + '/signage/' + this.$route.params.operation_rule_id + '/time-schedule/' + this.$route.params.time_schedule_id + this.urlBottom
    },
    getDestination() {
